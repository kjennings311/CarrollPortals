    ...
    public class HrController : Controller
    {
        ...
        public async Task<ActionResult> PrintPayRollStatusChange(string id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // o.Date=obj.
                //returning the employee list to view  
                return View("PrintPayRollStatusChange2", obj);
            }
        ...
        public async Task<ActionResult> PdfPayRollStatusChange(string id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                //returning the employee list to view  
                return new ViewAsPdf("PrintPayRollStatusChange2", obj) { PageSize = Size.A4, CustomSwitches = "--disable-smart-shrinking", FileName = "PayrollStatusChange-" + obj.SequenceNumber + "-" + obj.EmployeeName + ".pdf" };
