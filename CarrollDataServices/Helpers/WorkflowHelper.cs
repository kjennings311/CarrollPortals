        ...
        public static bool RunNotifyWorkflow(string RecordId, Char Type)
        {
            ...
            if(ConfigurationManager.AppSettings["NotifyWorkFlow"] == "true")
            {
                ...
                if (Type == 'P')
                {
                    ...
                    _message.Body = "<div style=\" padding: 30px; background:#b9b7b7;\"> <div style=\"background-color:white; padding:30px;\"> <h1> "+propresult.PropertyName + " </h1> <table  border='1' cellpadding='5' cellspacing='0'> <tr> <td style='width:20%;'> <strong> Address :  </strong> </td> <td> "+propresult.PropertyAddress +", "+propresult.City+", "+propresult.State+" "+propresult.ZipCode + " </td> </tr><tr><td><strong>  Phone :</strong> </td> <td>"+propresult.PhoneNumber+ " </td> </tr> <tr><td><strong>  Units :</strong> </td> <td>" + propresult.Units + " </td> </tr><tr><td><strong>  Yardi Code :</strong> </td> <td>" + propresult.PropertyNumber + " </td> </tr><tr><td><strong>  Legal :</strong> </td> <td>" + propresult.LegalName + " </td> </tr> <tr><td><strong>  Tax Id :</strong> </td> <td>" + propresult.TaxId + " </td> </tr> <tr><td><strong>  Partner :</strong> </td> <td>" + propresult.EquityPartnerSiteCode + " </td> </tr>    </table> <br> <br> <table border='1' cellpadding='5' cellspacing='0' >";
